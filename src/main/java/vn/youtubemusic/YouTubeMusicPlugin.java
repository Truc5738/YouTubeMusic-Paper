...
public final class YouTubeMusicPlugin extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        if (javaFeature < 25) {
            getLogger().severe("YouTubeMusic 2.12.0 yêu cầu Java 25 trở lên. Java hiện tại: " + Runtime.version());
        ...
        getLogger().info("YouTubeMusic 2.12.0 đã bật — Paper 26.2+ / Java 25+ / Java UI + Bedrock Forms.");
